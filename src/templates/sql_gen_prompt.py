...
-- 一条 SQL、UNION ALL 两个口径。每个口径返回第1名+目标班前后各3名并标记本班。排名池排除其他校和整班不足10人。用目标校+班定位窗口，禁止外层只留下目标班一行。</suggestion-answer>
  </example>
  <example>
