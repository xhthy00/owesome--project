...
async def node_persist_failure(state: TeamState, config: RunnableConfig) -> dict[str, Any]:
    ...
    if persist:
        ...
        record_id = await _persist_async(
            ...
            resolved_question=persist_constraints.resolved_question or request.question,
            turn_type=persist_constraints.turn_type,
            parent_record_id=persist_constraints.parent_record_id,
            sql="",
